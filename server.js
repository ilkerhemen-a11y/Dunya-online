...
io.on('connection', (socket) => {
    ...
    // ==========================================
    // SİLAH VE ZIRHÇI (DÜKKAN) SATIN ALMA İŞLEMİ
    // ==========================================
    socket.on('buyShopItem', async (data) => {
        try {
            ...
            const shopCatalog = {
                ...
                9: { name: 'Ateş Büyüsü Asası', icon: '🔮', type: 'weapon', strBonus: 15, vitBonus: 5, cost: 2500 },
                10: { name: 'Krallık Altın Tacı', icon: '👑', type: 'helmet', strBonus: 12, vitBonus: 15, cost: 3000 }
            };
