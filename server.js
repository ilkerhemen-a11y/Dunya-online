...
io.on('connection', (socket) => {
    ...
    // ==========================================
    // SİLAH VE ZIRHÇI (DÜKKAN) - SATIN ALMA
    // ==========================================
    socket.on('buyShopItem', async (data) => {
        try {
            ...
            // Dükkan Eşya Kataloğu (Minimum 1000 Altın)
            const shopCatalog = {
                ...
                5: { name: 'Yakut Kolye', icon: '📿', type: 'necklace', strBonus: 8, vitBonus: 8, cost: 1800 },
                6: { name: 'Zümrüt Yüzük', icon: '💍', type: 'ring', strBonus: 10, vitBonus: 5, cost: 2000 },
            ...
            socket.emit('marketResult', { 
                userData: user, 
                message: `🛒 ${newItem.name} satın alındı ve envanterinize eklendi!` 
            });
