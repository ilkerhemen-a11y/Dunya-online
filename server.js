...
const GAME_BUILD_ID = '2026-09-06-clan-war-daily-21-v1';
...
const CLAN_CASTLE_WAR_HOURS = [21];
...
server.listen(PORT, () => {
    ...
    console.log(`OYUN BUILD: ${GAME_BUILD_ID} | Macera Paketi: AKTİF | Dünya Bossu: AKTİF | Sezon: AKTİF | Klan Kale: 21:00 | 100 Onur = ${HONOR_RUBY_REWARD} Yakut`);
});const express = require('express');
const http = require('http');
const { Server } = require('socket.io');
const mongoose = require('mongoose');
